package android;
	...
	public class HEMapp {
	    ...
	    public void setup() throws Exception {
	        ...
	        //String deviceDetails = "safari";
	        
	        
	        
	        //launching a safari browser
	        
	        DesiredCapabilities caps = new DesiredCapabilities();
	        
	        caps.setCapability(MobileCapabilityType.BROWSER_NAME, MobileBrowserType.SAFARI);
	        caps.setCapability(MobileCapabilityType.DEVICE_NAME, "iPad Pro 11 2020");
	        
	        caps.setCapability("build", "Gen Cap - v1.0");
